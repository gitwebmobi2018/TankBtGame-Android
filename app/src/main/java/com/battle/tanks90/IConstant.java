...
public interface IConstant {
	...
	public  int STATE_OPTION = 4;
	public  int STATE_HELP = 5;
	public  int STATE_ABOUT = 6;
	public  int STATE_GAMEPLAY = 7;
	public  int STATE_IGM = 8;	
	public  int STATE_LOADING = 9;
	public  int STATE_SELECT_LEVEL = 10;
